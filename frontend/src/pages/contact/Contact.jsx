                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            ...
                            <p className="leads">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc id varius nunc.</p>
                        ...
                        <div className="col-lg-6 pt-2 pt-lg-0 mt-4 mt-lg-0">
                            <div id="map" className="contact_map2" data-zoom="12" data-latitude="40.680" data-longitude="-73.945" style={{backgroundImage : "url(assets/images/marker.png)", backgroundRepeat : "no-repeat"}}></div>
                        </div>
                    </div>
                </div>
            </div>
